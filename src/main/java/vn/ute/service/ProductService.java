...
import vn.ute.dao.ProductInfoDAO;
import vn.ute.entity.Category;
import vn.ute.entity.Paging;
import vn.ute.entity.ProductInfo;
import vn.ute.util.ConfigLoader;

@Service
public class ProductService {

    // Dependencies for existing ProductService
    @Autowired
    private ProductRepository productRepository;

    // Dependencies from inventory service
    @Autowired
    ...
    // -------------------- Product Management (Existing Functions) --------------------
    ...
    // -------------------- Category Functions (From inventory.service) --------------------
    ...
    // -------------------- Product Info Functions (From inventory.service) --------------------
